 ...
 * 
 * Displays turn-by-turn navigation directions when navigation is active.
 * Shows step-by-step instructions with directional icons and distances.
 * 
 * @param {boolean} isNavigating - Whether navigation is currently active
 * @param {array} navigationDirections - Array of direction objects with instruction, direction, and distance
 * @param {function} onResetNavigation - Callback to end/reset navigation
 */
export default function NavigationPanel({ isNavigating, navigationDirections, onResetNavigation }) {
  if (!isNavigating) return null;

  /**
   * Renders the directional icon based on the direction type
   */
